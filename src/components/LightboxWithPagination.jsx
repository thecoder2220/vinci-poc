...
class LightboxWithPagination extends Component {
    constructor(props) {
        super(props);
...
LightboxWithPagination.propTypes = {
...
LightboxWithPagination.defaultProps = {
...
LightboxWithPagination.childContextTypes = {
...
export default LightboxWithPagination;
